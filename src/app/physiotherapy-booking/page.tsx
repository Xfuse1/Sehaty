...
function PhysiotherapyBookingFlow() {
    ...
    useEffect(() => {
        if (!isUserLoading && !user) {
            sessionStorage.setItem('redirectAfterLogin', '/physiotherapy-booking');
            router.push('/login');
        } else if (user) {
    ...
    const handleConfirmBooking = async () => {
        ...
        const serviceName = language === 'ar' ? 'العلاج الطبيعي' : 'Physiotherapy';
        const message = `
...
- ${t.booking.whatsapp.price} ${bookingDetails.packagePrice} ${t.booking.currencySar}
    ...
    return (
        <div className="container py-12" dir={dir}>
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold font-headline text-primary">{t.booking.physioTitle}</h1>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <Textarea id="caseDescription" value={patientDetails.caseDescription} onChange={(e) => setPatientDetails({ ...patientDetails, caseDescription: e.target.value })} placeholder={t.booking.caseDescriptionPhysioPlaceholder} />
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <Button asChild variant="outline" className="h-24 flex-col gap-2 text-green-600 border-green-300 hover:bg-green-50 hover:text-green-700">
                                <Link href={`${whatsappLink}?text=${encodeURIComponent(t.booking.physioInquiry)}`} target="_blank">
