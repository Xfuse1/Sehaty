...
function ConfirmationCard() {
    ...
    // إنشاء بيانات QR Code تحتوي على معلومات المريض والحجز
    const bookingData = {
    ...
    const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?data=${encodeURIComponent(qrDataString)}&size=200x200`;
