...
const services = [
  {
    title: 'نظام الحجز',
    description: 'حجز مواعيد في العيادات مع نظام إشعارات وتذكيرات.',
    href: '#',
    imgSrc: 'https://picsum.photos/seed/booking/600/400',
    imgHint: 'doctor patient consultation',
  },
  {
    title: 'العمليات الجراحية',
    description: 'استشارات ما قبل العمليات ونظام حجز متخصص.',
    href: '#',
    imgSrc: 'https://picsum.photos/seed/surgery/600/400',
    imgHint: 'surgeons operating room',
  },
  {
    title: 'العلاج الطبيعي',
    description: 'جدولة جلسات العلاج الطبيعي ومتابعة خطط العلاج.',
    href: '#',
    imgSrc: 'https://picsum.photos/seed/physiotherapy/600/400',
    imgHint: 'physical therapy exercise',
  },
  {
    ...
    imgHint: 'pharmacy shelves medication',
  },
  {
    title: 'العيادات المتخصصة',
    description: 'تصفح التخصصات الطبية واختيار الأطباء المعتمدين.',
    href: '#',
    imgSrc: 'https://picsum.photos/seed/clinics/600/400',
    imgHint: 'clinic waiting room',
  },
  {
    title: 'الخدمات المخبرية',
    description: 'حجز زيارات لجمع العينات ونتائج التحاليل الرقمية.',
    href: '#',
    imgSrc: 'https://picsum.photos/seed/lab/600/400',
    imgHint: 'scientist laboratory',
  },
  {
    title: 'الكشف المنزلي',
    description: 'زيارات طبية منزلية وتشخيص أولي عن بعد.',
    href: '#',
  ...
  },
  {
    ...
    description: 'حجز خدمات تمريضية منزلية ومتابعة الحالات المزمنة.',
    href: '#',
    imgSrc: 'https://picsum.photos/seed/nursing/600/400',
    imgHint: 'nurse patient care',
  },
];
